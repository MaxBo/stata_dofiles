...
program define pwnetupdate, rclass
	...
	///////////////////////////////////////////////////////////////////////////////////////
	/* si ch pc */
    local allprefixes         = "pw pa cn cc oz ac bp mz mc de sl uk li hr"        // affects order of update check, installing, ...

	/*pc5500*/
	
	/* sipp shp */
	local pkg_main_subdirs    = "pwadmin soep soeplong hilda lsac iabbp mikroz mzpc cpsnber cpscepr  bhps luxis share"   // "base" must not be specified!	
	local pw_name             = "BASE"
	local pa_name             = "PWADMIN"
	local de_name             = "SOEP"
	local sl_name             = "SOEP-LONG"
	local oz_name             = "HILDA"
	local ac_name             = "LSAC"
	local uk_name             = "BHPS"
...
*/
	...
	local sl_subdirs          = "soeplong/base soeplong/labelinfo soeplong/plugins soeplong/index soeplong/datasetup"
	...
	local hr_subdirs          = "share/base share/labelinfo share/plugins share/index share/datasetup"
/*
...
*/
	...
	local hr_aux_subdirs      = "share/views"
	local sl_aux_subdirs      = "soeplong/views"
/*
