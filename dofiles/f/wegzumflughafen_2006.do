...
* Reisedatensatz : bysort P1012: tab P1014 if P1013_4 ==1
* 77% der Reisen, die mit dem Flieger unternommen werden, sind mit max. 3 Übernachtungen, 64 % mit max. 2 Übernachtungen, 43% mit 1 Übernachtung
* histogram  P1016 if  P1013_4 ==1 &  P1012==1 // Länge der innerdeutsche Flüge; durchschnittlich 679 km mit s = 185 km  min=300 max = 1587, n=191
