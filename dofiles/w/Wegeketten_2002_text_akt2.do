...
clear
set memory 32m
use "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2002\MiD_2002_Wege_zeitn5.dta", clear

rename W08 WEGKM_K

* differenzierte Wegezwecke umbenennen
...
* replace W04_DZW = . if W04 ==4 | W04 ==5 | W04 ==7
...
bysort HHID PID:replace wegpaar = "Wohnen"+" - "+Zweck[_n] if _n==1 & (W01 == 1  |  WSIDN ==101)
bysort HHID PID:replace wegpaar = "Sonstige"+" - "+Zweck[_n] if (W01 != 1) & WSIDN[_n]==1
...
save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2002\MiD_2002_Wege_zeitn5_akt.dta", replace
