...
bysort id_hhpw: replace Zweck = "Einkauf periodisch" if W04 == 4 & W041 == 501
bysort id_hhpw: replace Zweck = "Einkauf aperiodisch" if W04 == 4 & W041 != 501
...
bysort id_hhpw: gen wegpaar = Zweck[_n-1]+" - "+Zweck[_n] if _n>1
bysort id_hhpw: replace wegpaar = "Wohnen"+" - "+Zweck[_n] if Zweck[_n] == "Wohnen" |  (_n==1 & W01 == .a)
