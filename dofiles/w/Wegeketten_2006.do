...
bysort id_hhp: gen Zweck = 2 if W04 == 1 | W13 == 2
bysort id_hhp: replace Zweck = 5 if W04 == 3 | W04 == 31
bysort id_hhp: replace Zweck = 9 if (W01 == 1 & W13 == 1) | W13 == 5
bysort id_hhp: replace Zweck = 1 if W04[_n] == 8
bysort id_hhp: replace Zweck = 10 if W04 == 11 | W04 == 6
bysort id_hhp: replace Zweck = 3 if W04 == 4 & W041 == 501
bysort id_hhp: replace Zweck = 4 if W04 == 4 & W041 != 501
bysort id_hhp: replace Zweck = 7 if W04 == 7 | W04 == 5
bysort id_hhp: replace Zweck = 6 if W04 == 32
bysort id_hhp: replace Zweck = 8 if W04 == 10 | W04 == .a| W04 == .g 
...
* bysort id_hhp: gen wegpaar = Zweck[_n-1]+" - "+Zweck[_n] if _n>0
* bysort id_hhp: replace wegpaar = "Wohnen"+" - "+Zweck[_n] if W01 == 1 |  (_n==1 & W01 == .a)

* Wegekette generieren:
* bysort id_hhp: gen wegekette = wegpaar[_n] if _n==1
* bysort id_hhp: replace wegekette = wegekette[_n-1]+" ; "+ wegpaar[_n] if _n>1

* Wegeketten generieren mit Wohnen als Heimbasis
* bysort id_hhp: gen wegekette_home = wegpaar[_n] if _n==1 | Zweck[_n-1] == 1
* bysort id_hhp: replace wegekette_home = wegekette_home[_n-1]+" ; "+ wegpaar[_n] if _n>1 & missing(wegekette_home)
