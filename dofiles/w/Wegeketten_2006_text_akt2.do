...
bysort HHID PID:replace wegpaar = "Sonstige"+" - "+Zweck[_n] if (W01 == 2 | W01 == -39) & WSIDN[_n]==1
* bysort HHID PID:replace wegpaar = "Arbeiten"+" - "+Zweck[_n] if W01 ==2 & WSIDN==1 
* bysort HHID PID:replace wegpaar = "Arbeiten"+" - "+Zweck[_n] if (W01 > 1 | W01 <5) & WSIDN==1 & W13 == 1 & HWZWECK ==1 
