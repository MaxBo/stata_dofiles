...
bysort HHID PID: replace Zweck = 2 if Zweck==11 & (Zweck[_n-2]==9 |Zweck[_n-3]==2) & _n>1
...
bysort HHID PID: gen Zweck_text = "A" if W04 == 1 | W13 == 2
bysort HHID PID: replace Zweck_text = "B" if W04 == 3 | W04 == 31
bysort HHID PID: replace Zweck_text = "W" if W04 == 8| W13 == 1
bysort HHID PID: replace Zweck_text = "Begl" if W04 == 11 | W04 == 6
bysort HHID PID: replace Zweck_text = "F/E" if W04 == 7 | W04 == 5
bysort HHID PID: replace Zweck_text = "K" if W04 == 32
bysort HHID PID: replace Zweck_text = "S" if W04 == 10| W04 > 100
bysort HHID PID: replace Zweck_text = "Rü" if  W04 == 9
bysort HHID PID: replace Zweck_text = "FW" if  W04_DZW == 701
bysort HHID PID: replace Zweck_text = "Ru" if (W01 == 1 & W13 == 1) | W13 == 5 | (W04_DZW>709 & W04_DZW<713)
bysort HHID PID: replace Zweck_text = "d_per" if WSID > 100
bysort HHID PID: replace Zweck_text = "d_aper" if W04 == 2 & WSID < 100
bysort HHID PID: replace Zweck_text = "E_per" if W04_DZW == 501
bysort HHID PID: replace Zweck_text = "E_aper" if (W04_DZW > 501 & W04_DZW < 600) | (W04==4 & W04_DZW==.a)
bysort HHID PID: replace Zweck_text = "A" if Zweck==11 & W04[_n-2]==1 & _n>1
bysort HHID PID: replace Zweck_text = "A" if Zweck==11 & (Zweck[_n-2]==9 |Zweck[_n-3]==2) & _n>2
bysort HHID PID: replace Zweck_text = "W" if Zweck==11 & (Zweck[_n-2]==1 | W01[_n-2]==1) & _n>2
bysort HHID PID: replace Zweck_text = "W" if Zweck==11 & (Zweck[_n-2]==9 | W01[_n-2]==1) & _n>2
bysort HHID PID: replace Zweck_text = "B" if Zweck==11 & Zweck[_n-2]==5 & _n>2
* bysort HHID PID: replace Zweck_text = "A" if W04[_n-1] == 1 | W04 == 14
...
bysort HHID PID:replace wegpaar = "W"+" - "+Zweck_text[_n] if Zweck[_n-1] ==9 & ((_n-1==1 & (W01 [_n-1] == 1  | (WSOURCE[_n-1] == 1 & WSIDN[_n-1] ==101)))|(Zweck[_n-2]==1&_n>1))
...
* sort   id_hhp arbeit
save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_Wege_6n.dta", replace

* Markierung negativer Aktivitätendauern für alle Wege der Person bis zur Editieransicht

* foreach x of arbeit bilden eink_ap freizeit kindergarten {
*	save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_Wege_7.dta", replace
*	sort   id_hhp x
*	save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_Wege_7.dta", replace
	
*	keep id_hhp x
*	keep if x==1
*	save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_HA"+x+".dta"
*	sort   id_hhp x
*	clear
	
*	use "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_Wege_6.dta"
*	merge id_hhp arbeit using "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_HA.dta", uniqusing  _merge(HA_x)
	
	
*	save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_Wege_7"+x+".dta", replace
...
* keep id_hhp arbeit bilden eink_ap freizeit kindergarten
* keep if arbeit==1 | bilden==1  | eink_ap==1  | freizeit==1  | kindergarten==1
* save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_HA.dta", replace
* sort id_hhp arbeit
* save "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_HA.dta", replace
* clear
...
* merge id_hhp arbeit using "C:\Spitzencluster Luftverkehr\Modell\Nachfragedaten\MiD_Codiert\2008\MiD_2008_HA.dta", uniqusing  _merge(HA_1)
