...
set more off
capture log close
log using "$PW_workingdir\soep\proj\FS\st_pkw_fs160609.log",replace
...
streg _age_* _fem_* pincln adult2 adult3 oa* mixedneighb house_* city_* shop?? notransit, dist(e) log nocons nohr
...
streg _age_* _fem_* pincln adult2 adult3 oa_* mixedneighb house_* city_* shop?? , dist(e) log nocons nohr
estimates save $PW_workingdir\soep\proj\FS\est\FS10exp,replace
gen pkwimmer = pkw==31 | pkw==3
gen pkwzeitw = pkw==21 | pkw==2
streg _age_* _fem_* pincln adult2 adult3 oa_* mixedneighb house_* city_* shop?? pkwimmer pkwzeitw , dist(e) log nocons nohr
...
capture log close
log using "$PW_workingdir\soep\proj\FS\st_pkw160609.log",replace
...
stphplot, by(taet) plot1opts(msymbol(i))  plot2opts(msymbol(i)) plot3opts(msymbol(i)) plot4opts(msymbol(i)) plot5opts(msymbol(i)) plot6opts(msymbol(i))
streg _age_* _fem_* pincln adult2 adult3 kid? oa_* mixedneighb house_* city_* shop?? , dist(e) log nocons nohr
