...
MiDH_rInc, benzin(0.1224) citymaut  // 6.8 Liter bei Benzinpreis von 1.80 €

predict ProbSpritCM if _sample, pc1
egen PGesSpritCM = total(ProbSpritCM)
bysort AltNum: egen PAltSpritCM= total(ProbSpritCM)
replace PAlt = PAltSpritCM / PGesSpritCM * 100
gen FLGewSpritCM = ProbSpritCM* MeterKfz * 322 / 1000
gen PersGewSpritCM = ProbSpritCM * 322
tab p [iw=FLGewSpritCM]
tab p [iw=PersGewSpritCM]
tab v [iw=PersGewSpritCM]
tab z [iw=PersGewSpritCM]

MiDH_rInc, benzin(0.1224) regiomaut citymaut // 6.8 Liter bei Benzinpreis von 1.80 €

predict ProbSpritRMCM if _sample, pc1
egen PGesSpritRMCM = total(ProbSpritRMCM)
bysort AltNum: egen PAltSpritRMCM= total(ProbSpritRMCM)
replace PAlt = PAltSpritRMCM / PGesSpritRMCM * 100
gen FLGewSpritRMCM = ProbSpritRMCM* MeterKfz * 322 / 1000
gen PersGewSpritRMCM = ProbSpritRMCM * 322
tab p [iw=FLGewSpritRMCM]
tab p [iw=PersGewSpritRMCM]
tab v [iw=PersGewSpritRMCM]
tab z [iw=PersGewSpritRMCM]

MiDH_rInc, benzin(0.1224) regiomaut citymaut jobticket // 6.8 Liter bei Benzinpreis von 1.80 €
...
*/ F R Bus Bahn M  /*
*/ tFuss tRad tPkw tMF tOV_FZ  tOV_SWZ_* tOV_UH tOV_Gehzeit tOV_WZ cOV_* /*
*/ cPkw_* cPkwM_* cParkWage_*  if _sample||v : , ||PkwZK: , || AltNum:  ,noconst case(PersId) constr(1/4)
