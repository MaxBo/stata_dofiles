...
program define MOP_genvar_rinc
...
quietly {
dropvars hhrinc restinc hinc
gen hinc = EINKO*500-200
replace hinc = 4500 if EINKO==8
...
gen hhrinc =  hinc-400-230*ERWACHSENE-200*KIND
