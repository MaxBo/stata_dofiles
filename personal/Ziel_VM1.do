insheet using "Y:\data\biogeme\Beruf\Sample\Wege12.dat", case
drop v*
forvalues j = 0/9 {
...
ml init /lambda=1 /t_Rad=1 /t_OV=0.5 /UH=5 /ZZ=2 /SW=2 /t_Pkw=2 /cost_Pkw=6 /const_Rad=0 /const_OV=0 /const_PkwF=0 /const_PkwMF =-1 /beta_e=-0.2
